    ...
    *_,
    ...
    if action_name == "escape":
        ...
        try:
            ...
            raise EventParsingError(f"No action named {action_name!r}")
        if target is None:
            raise EventParsingError(f"Action {action.name!r} requires a target.")
...
def parse_monster_action(
    ...
    *_,
    ...
    try:
        ...
        raise EventParsingError(
            f"Available actions for {monster.name}: " f"{action_names}"
        )
