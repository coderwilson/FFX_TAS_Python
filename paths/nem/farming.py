...
class MiihenFarm(AreaMovementBase):
    checkpoint_coordiantes = {
        ...
        6: [-15, 302],
        7: [-57, 348],
        8: [-57, 450],  # To the map with encounters
        9: [-173, -815],
        10: [-159, -715],
        11: [-117, -623],
        12: [-46, -501],
        ...
        27: [426, 249],
        28: [605, 370],
        29: [610, 411],  # Farm zone 1
        30: [593, 552],  # Farm zone 2
        31: [500, 700],  # To the "meeting Seymour" screen
        32: [-300, -305],  # Return to newroad
        33: [-107, -250],  # Branch to zone 2 vs zones >= 3
        34: [-68, -69],
        35: [14, -68],  # Entrance towards area 2
        36: [185, -223],
        37: [227, -274],
        ...
        51: [-87, -1100],  # Farm area 3(A)
        52: [-87, -911],  # Farm area 3(A)
        53: [-46, -757],
        54: [-44, -716],
        55: [-48, -643],
        56: [-23, -571],
