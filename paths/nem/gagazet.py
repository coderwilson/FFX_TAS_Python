...
class GagazetFarm(AreaMovementBase):
    checkpoint_coordiantes = {
        0: [39, 99],  # Arrival, start of sections 2/4
        1: [54, 105],  # Platform, to cave
        2: [0, 0],  # Activate platform
        3: [95, -946],
        4: [27, -830],
        5: [24, -658],
        6: [15, -553],
        7: [61, -482],
        8: [178, -363],
        9: [250, -190],  # To Wakka trials zone
        10: [-55, -414],
        11: [-82, -475],
        12: [-55, -600],  # Return when complete
        13: [65, -484],
        14: [19, -555],
        15: [18, -659],
        16: [42, -785],
        ...
        24: [12, -855],
        25: [0, -961],
        26: [0, -1100],  # Back to campfire map
        27: [97, -56],
        28: [111, 28],
        29: [0, 0],  # End of Zanarkand Overpass section
        30: [36, 85],  # Start of Mountain Path
        31: [20, 165],
        32: [42, 266],
        33: [59, 369],
        34: [70, 600],  # To mountain path
        35: [-10, -60],
        36: [7, -146],
        37: [7, -300],  # Return when complete
        38: [52, 329],
        39: [34, 218],
        40: [21, 125],  # End of Mountain Path
        41: [30, 83],  # Back towards save sphere
        42: [-37, 87],
        43: [0, 0],  # Return to airship, or touch sphere and start over
        44: [8, -51],
        45: [19, 81],
        46: [45, 241],
        47: [63, 349],
